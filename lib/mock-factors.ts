...
const TEMPLATES: FactorTemplate[] = [
  {
    ...
    defaultWeight: 0.35,
    subFactors: [
      { name: "US 10Y Real Yield", weight: 12, detail: "Real yield inversely correlated with gold; rising yields pressure gold", relevantHorizons: ["swing", "longterm"] },
      { name: "Treasury Yield Curve", weight: 4, detail: "Yield curve shape signals recession risk and safe-haven demand", relevantHorizons: ["swing", "longterm"] },
      { name: "Inflation Expectations", weight: 6, detail: "Breakeven inflation rates drive gold as an inflation hedge", relevantHorizons: ["swing", "longterm"] },
      { name: "Fed Rate Expectations", weight: 6, detail: "Fed funds futures pricing for next meeting and forward path", relevantHorizons: ["swing", "longterm"] },
      { name: "DXY Index", weight: 5, detail: "US Dollar Index inversely correlated with gold prices", relevantHorizons: ["intraday", "swing", "longterm"] },
      { name: "Geopolitical Tensions", weight: 2, detail: "Global conflict index and geopolitical risk premium", relevantHorizons: ["intraday", "swing", "longterm"] },
      { name: "Global Liquidity", weight: 4, detail: "Central bank balance sheet expansion supports gold", relevantHorizons: ["longterm"] },
      { name: "GDP Growth", weight: 2, detail: "Slowing GDP growth increases safe-haven appeal", relevantHorizons: ["longterm"] },
  ...
  },
  {
    ...
    defaultWeight: 0.20,
    subFactors: [
      { name: "Open Interest Change", weight: 4, detail: "Rising OI with price confirms trend strength", relevantHorizons: ["intraday", "swing"] },
      { name: "OI + Price Divergence", weight: 4, detail: "Divergence between OI and price signals potential reversal", relevantHorizons: ["intraday", "swing"] },
      { name: "Volume Delta", weight: 3, detail: "Buy vs sell volume imbalance indicates directional pressure", relevantHorizons: ["intraday"] },
      { name: "Large Trader Positioning", weight: 3, detail: "Institutional order flow and block trade patterns", relevantHorizons: ["intraday", "swing"] },
      { name: "VWAP Deviation", weight: 2, detail: "Price relative to VWAP signals intraday fair value", relevantHorizons: ["intraday"] },
      { name: "Bid-Ask Spread", weight: 2, detail: "Widening spreads indicate stress; tight spreads mean confidence", relevantHorizons: ["intraday"] },
      { name: "COT Net Speculative", weight: 4, detail: "CFTC Commitment of Traders speculative net positioning", relevantHorizons: ["swing", "longterm"] },
      { name: "ETF Flows (GLD/IAU)", weight: 4, detail: "Gold ETF inflows/outflows signal institutional sentiment", relevantHorizons: ["swing", "longterm"] },
    ],
  },
  {
    id: "technical",
  ...
  },
  {
    ...
    subFactors: [
      ...
      { name: "Retail Sentiment", weight: 1, detail: "Retail investor positioning as a contrarian indicator", relevantHorizons: ["swing"] },
      { name: "Central Bank Buying", weight: 1, detail: "Global central bank gold reserve accumulation trends", relevantHorizons: ["longterm"] },
      { name: "Jewelry Demand", weight: 1, detail: "Consumer jewelry demand from India, China, Middle East", relevantHorizons: ["longterm"] },
